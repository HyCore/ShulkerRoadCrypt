// ==UserScript==
// @name         ShulkerRoadCrypt
// @namespace    https://github.com/HyCore/ShulkerRoadCrypt/
// @version      1.4.0.3
...
// Credits for inspiration to the original DiscordCrypt & SimpleDiscordCrypt

(function() {

'use strict';

const BlacklistUrl = "https://github.com/HyCore/ShulkerRoadCrypt/raw/master/blacklist.txt";
...
var Discord;
var Utils = {
    Log: (message) => { console.log(`%c[ShulkerRoadCrypt] %c${message}`, `color:${BaseColor};font-weight:bold`, "") },
    Warn: (message) => { console.warn(`%c[ShulkerRoadCrypt] %c${message}`, `color:${BaseColor};font-weight:bold`, "") },
    Error: (message) => { console.error(`%c[ShulkerRoadCrypt] %c${message}`, `color:${BaseColor};font-weight:bold`, "") }
};
var DataBase;
var Cache;
var Blacklist;
...
function Init(nonInvasive)
{
    ...
    Object.assign(Utils, {
        ...
        DownloadDb: async function(uncompressed) {
            ...
            this.DownloadBlob(uncompressed ? "ShulkerRoadCrypt.json" : "ShulkerRoadCrypt.dat", new Blob([buffer]));
        },
                ...
                message: {
                    ...
                    embed: {
                        ...
                        author: {
                            ...
                            url: "https://github.com/HyCore/ShulkerRoadCrypt/"
                        },
                        description: sysmsg,
                        footer: {
                            text: "ShulkerRoadCrypt",
                            icon_url: "https://i.imgur.com/sy5rhRb.png",
                        }
                    }
                }
            }, () => { /*TODO*/ });
...
async function handleUpdate(event) {
    ...
    if(message.content == null && message.embeds != null && message.embeds.length === 1) {
        ...
        if(embed.footer != null && (embed.footer.text === "ShulkerRoadCrypt" || embed.footer.text === "𝘚𝘩𝘶𝘭𝘬𝘦𝘳𝘙𝘰𝘢𝘥𝘊𝘳𝘺𝘱𝘵")) {
...
const messageRegex = /^([⠀-⣿]{16,}) `(?:ShulkerRoadCrypt|𝘚𝘩𝘶𝘭𝘬𝘦𝘳𝘙𝘰𝘢𝘥𝘊𝘳𝘺𝘱𝘵)`$/;
...
async function processEmbeds(message, ignoreAttachments) {
    ...
    let embed = message.embeds[0];
    if(embed.footer == null || (embed.footer.text !== "ShulkerRoadCrypt" && embed.footer.text !== "𝘚𝘩𝘶𝘭𝘬𝘦𝘳𝘙𝘰𝘢𝘥𝘊𝘳𝘺𝘱𝘵")) return;
...
async function handleSend(channelId, message, forceSimple) {
    ...
    if(forceSimple || Cache.channelBlacklist === 2 || (channel.type === 0 && !Discord.can(EMBED_LINKS_CHECK, Discord.getCurrentUser(), channel))) {
       message.content = payload + " `𝘚𝘩𝘶𝘭𝘬𝘦𝘳𝘙𝘰𝘢𝘥𝘊𝘳𝘺𝘱𝘵`";
    }
    else {
        message.content = "";
        message.embed = {
            ...
            author: {
                ...
                icon_url: "https://i.imgur.com/pFuRfDE.png",
                url: "https://privacy.shulkerroad.com/"
            },
            description: payload,
            footer: {
                text: "ShulkerRoadCrypt",
